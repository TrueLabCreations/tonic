import Test, {test} from "./tapzero";
import LiveElement from '../dist/LiveElement';

// const test = require("tapzero").test
// const uuid = require("uuid")
// const Tonic = require("../index.js")

const sleep = async (t:any) => new Promise((resolve) => setTimeout(resolve, t))

test("Sanity", async (t) => {
  t.ok(true, "Sanity check passed")
});

test("Create div", async (t) =>{

  document.body.innerHTML = "<div>Test</div>";

  const div = document.querySelector("div");

  t.ok(div, "Div created");

});

test("Create LiveElement", async(t) =>{
  class SimpleDiv extends LiveElement{
